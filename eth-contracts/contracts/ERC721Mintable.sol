...
contract Ownable {
    ...
    event OwnershipTransfered(address nextOwner);
        modifier onlyOwner ()
    {
...
contract Pausable is Ownable{
    ...
    function setPaused(bool pause) public onlyOwner{
        require(_paused != pause, "Value is same as Paused.");
        _paused = pause;
        if(pause){
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "Sending it to is the token owner");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId],msg.sender),"Only owner or approved can call this");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(address(0) !=to || !_exists(tokenId),"Invalid address or token already exists with that id");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "Caller is not the owner of that token");
        // TODO: require token is being transfered to valid address
        require(address(0) !=to || _exists(tokenId),"Invalid address ortToken doesnt exist with that id");
        // TODO: clear approval
...
contract RealEstateToken is ERC721Metadata("Title Token","TITLE","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
